        ...
        <div ref={forwardedRef} id='About' className='text-[#FFFFFF] relative'>
            ...
            <div className='w-[80vw] mx-auto my-[2rem]'>
                <p className='font-[700] text-[16px]'>
                    ...
                    <span className='font-normal text-[14px]'> I hold a Bachelor's degree in Electronics and Communication Engineering, graduated in 2022 from MJCET.
